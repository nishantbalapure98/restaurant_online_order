...
function LoyaltyRewardsSection({ loyaltyData, setLoyaltyData }) {
  ...
  const availableRewards = [
    {
      ...
      pointsCost: 500,
      image:
        'https://images.pexels.com/photos/1633578/pexels-photo-1633578.jpeg?w=300&h=200&fit=crop',
      category: 'food',
      validUntil: addDays(new Date(), 30),
      termsAndConditions:
        'Valid for appetizers up to $15. Cannot be combined with other offers.',
    },
    {
      id: 2,
      ...
      pointsCost: 750,
      image:
        'https://images.pixabay.com/photo/2022/01/11/21/48/food-6931438_960_720.jpg?w=300&h=200&fit=crop',
      category: 'discount',
    ...
    },
    {
      ...
      pointsCost: 1500,
      image:
        'https://images.pexels.com/photos/4393426/pexels-photo-4393426.jpeg?w=300&h=200&fit=crop',
      category: 'service',
      validUntil: addDays(new Date(), 90),
      termsAndConditions:
        'Valid for 30 days from redemption date. No minimum order required.',
    },
    {
      id: 5,
      ...
      pointsCost: 2000,
      image:
        'https://images.pixabay.com/photo/2020/12/07/16/35/restaurant-5813046_960_720.jpg?w=300&h=200&fit=crop',
      category: 'status',
      validUntil: addDays(new Date(), 120),
      termsAndConditions:
        'Includes priority support, exclusive offers, and faster delivery.',
    },
    {
      id: 6,
      ...
      termsAndConditions:
        'Meal selection based on chef recommendations and seasonal ingredients.',
    },
  ];
  ...
  const getProgressPercentage = () => {
    ...
    const progress =
      ((loyaltyData?.points - currentTierInfo?.min) /
            ...
            <div className="space-y-6">
              ...
              <div className="bg-accent-50 border border-accent-100 rounded-lg p-6">
                ...
                <p className="text-text-secondary font-body mb-4">
                  Invite friends to TasteBite and both of you get 500 bonus
                  points when they place their first order!
                </p>
                  ...
                  {pointsHistory?.slice(0, 5)?.map((activity, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        >
                          <Icon
                            name={getPointsIcon(activity?.type)}
                            size={16}
                            className={getPointsColor(activity?.type)}
                          />
                        </div>
                      ...
                      <span
                        className={`font-body font-body-medium ${
                          activity?.amount > 0
                            ? 'text-success-600'
                            : 'text-error-600'
                        }`}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {availableRewards?.map(reward => (
                  <div
                    key={reward?.id}
                    className="bg-surface border border-border rounded-lg overflow-hidden shadow-soft hover:shadow-floating transition-smooth"
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-xs text-text-secondary font-body mb-4">
                        <span>
                          Valid until {format(reward?.validUntil, 'MMM dd')}
                        </span>
              ...
              <div className="space-y-3">
                {pointsHistory?.map((activity, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <span
                        className={`text-lg font-body font-body-medium ${
                          activity?.amount > 0
                            ? 'text-success-600'
                            : 'text-error-600'
                        }`}
