      ...
      <div className="space-y-6">
        {timeline.map((step, index) => {
          const isCompleted =
            ...
            (index === currentStepIndex && step.timestamp);
          ...
          return (
            <div key={step.status} className="relative">
              ...
              <div className="flex items-start space-x-4">
                {/* Status Icon */}
                <div
                  className={`w-12 h-12 rounded-full border-2 flex items-center justify-center transition-smooth ${getStatusColor(
                    step.status,
                    isActive,
                    isCompleted
                  )}`}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-2">
                    <h3
                      className={`font-heading font-heading-medium ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-lg font-heading font-heading-medium text-primary">
                {formatEstimatedTime(
                  timeline.find(step => step.status === 'delivered')
                    ?.estimatedCompletion
                ) || 'Calculating...'}
              </p>
            </div>
