...
import { addToCart, removeFromCart, updateQuantity as updateQuantityAction } from 'Redux/cartSlice';
...
function ShoppingCartCheckout() {
  ...
  const cartCustomizations = useSelector(state => state.cart.customizations);
  const dispatch = useDispatch();

  //console.log(mockCartItems2);
  ...
  const getEstimatedPrepTime = () => {
    if (!cartItems || cartItems.length === 0) return 0;
    const maxPrepTime = Math.max(...cartItems.map(item => item.prepTime || 0));
                        ...
                        <div className="flex-1">
                          ...
                          {cartCustomizations.length > 0 && (
                            ...
                            >
                              ...
                              />
                              <span>
                                Customizations ({cartCustomizations.length})
                              </span>
                            </button>
                          )}
